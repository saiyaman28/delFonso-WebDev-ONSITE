...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2024 at 06:52 AM
...
INSERT INTO `reservation` (`res_id`, `room`, `user`, `res_date`, `res_time`) VALUES
(1, 4, 3, '2024-07-30', 1),
(2, 4, 3, '2024-07-30', 2),
(3, 4, 3, '2024-07-30', 3),
(4, 6, 4, '2024-07-25', 3),
...
INSERT INTO `users` (`user_id`, `first_name`, `middle_name`, `last_name`, `program`, `rank`, `ama_number`, `email`, `password`, `admin`) VALUES
(1, 'User', '', 'Admin', 3, 3, '0', 'bayashi.x28@gmail.com', '$2y$10$IbCHYXVD2e.A73hyvlIR9eplX0Mn/tpBdRzb0rnM4VspLUDlXvtmC', 1),
(2, 'Dylan Clive', 'Espiritu', 'Espino', 5, 1, '20058102142', 'dylanyakespino@gmail.com', '$2y$10$ZPOJuli6hJDZQPCOM3XuGueRIhsWGzdKmaTzKYFrtDyq4R2hNvLHa', 0),
(3, 'Micheal Lance Kester', '', 'Li', 5, 1, '23023232323', 'kesterpogi@gmail.com', '$2y$10$bxDkh484fSQ94p.QWUYFcOxahmAM3H9R.dzSBTERzzeBBm3X5rzWy', 0),
(4, 'Gelizza Marie', 'Espiritu', 'Novino', 5, 1, '20005874233', 'geligigil@gmail.com', '$2y$10$edxTihajrvRMPy.v9aDwnuMusanaBZnI8sZvQ7ndN1Lhr4mD2afQq', 0),
(5, 'Whendell', '', 'Tan', 6, 1, '19231450001', 'whendell@gmail.com', '$2y$10$OUSW/VuolX7r.Y/RH5S5T.1gLxEpJVWY0fZS26B/jrHOH8usBGJHW', 0);
